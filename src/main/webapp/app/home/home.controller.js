(function () {
    ...
    HomeController.$inject = ['$scope', '$state', 'Chart', 'Principal', 'LoginService', 'Preference', 'Points', 'BloodPressure', 'Weight'];

    function HomeController ($scope, $state, Chart, Principal, LoginService, Preference, Points, BloodPressure, Weight) {
        var vm = this;
        ...
        function getAccount() {
            Principal.identity().then(function (account) {
                ...
                if (vm.isAuthenticated()) {
                    Preference.user(function (preferences) {
                        vm.preferences = preferences;
                    });

                    Points.thisWeek(function (data) {
                        console.log("Puntos obtenidos esta semana", data);
